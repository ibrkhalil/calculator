...
const hs = documentgetElementById("H/s")
const khs = documentgetElementById("KH/s")
const mhs = documentgetElementById("MH/s")
const ghs = documentgetElementById("GH/s")
const ths = documentgetElementById("TH/s")
