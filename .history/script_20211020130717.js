...
function handleCoinChange(e) {
    switch (e.target.value) {
        case "BTC":
            state.selectedItemPrice = "1 BitCoin = " + BTCPrice
            state.selecteitemIcon = BTCLogo
            console.log(BTCLogo);
            break;
        case "LiteCoin":
            state.selectedItemPrice = "1 LiteCoin = " + LTCPrice
            state.selecteitemIcon = LTCLogo
            break;
        case "DogeCoin":
            state.selectedItemPrice = "1 DogeCoin = " + DOGEPrice
            state.selecteitemIcon = DOGELogo
            break;
    }
    UNIT.textContent = parseFloat(state.selectedItemPrice)
