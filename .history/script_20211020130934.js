let state = {
    selectedItemPrice: BTCPrice,
    selecteitemIcon: BTCLogo
}
...
function handleCoinChange(e) {
    switch (e.target.value) {
        case "BTC":
            state.selectedItemPrice = "1 BitCoin = " + parseFloat(BTCPrice).toFixed(3) + "$"
            state.selecteitemIcon = BTCLogo
            console.log(BTCLogo);
            break;
        case "LiteCoin":
            state.selectedItemPrice = "1 LiteCoin = " + parseFloat(LTCPrice).toFixed(3) + "$"
            state.selecteitemIcon = LTCLogo
            break;
        case "DogeCoin":
            state.selectedItemPrice = "1 DogeCoin = " + parseFloat(DOGEPrice).toFixed(3) + "$"
